...
<form class="modal-content animate" action="php/registrar_cliente.php" method="POST" class="fomulario_reg" onsubmit="return validarData();">
	<div id="body">
...
<label for="psw"><b>Dirección</b></label>
    <input type="text" placeholder="Digite su dirección" id="correo" name="direccion" >
<br>
